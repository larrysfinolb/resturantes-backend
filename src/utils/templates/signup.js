export const signupTemplate = (link) => `
  <!DOCTYPE html>
                ...
                <tr>
                  <td>
                    <table
                      ...
                      role="presentation"
                      style="color: #000; width: 600px; margin: 0 auto"
                      width="600"
                    >
                      <tbody>
                        <tr>
                              ...
                              <tr>
                                <td class="pad" style="width: 100%">
                                  <div align="center" class="alignment" style="line-height: 10px">
                                    <img
                                      src="https://resturatesstorage.blob.core.windows.net/others/email.jpeg"
                              ...
                              <tr>
                                <td class="pad">
                                  <h1
                                    ...
                                    "
                                  >
                                    <span class="tinyMce-placeholder">Verifica tu email</span>
                                  </h1>
                                </td>
                              </tr>
                            </table>
